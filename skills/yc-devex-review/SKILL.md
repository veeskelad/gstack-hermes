---
name: yc-devex-review
description: Live developer experience audit. (gstack)
version: 1.0.0
metadata:
  hermes:
    tags: [yc, review, devex, onboarding]
    related_skills: []
...
scorecard with evidence. Compares against /yc-devex-review scores if they
...
# /yc-devex-review: Live Developer Experience Audit
...
\`~/.claude/skills/gstack/yc-devex-review/dx-hall-of-fame.md\`
...
Check for prior /yc-devex-review scores:
...
If /yc-devex-review scores exist from the baseline check:
...
- Re-run /yc-devex-review after fixes to verify improvement
- If boomerang showed significant gaps, re-run /yc-devex-review on the next feature plan
