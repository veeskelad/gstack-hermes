...
metadata:
  hermes:
    tags: [yc, review, batch, orchestrator]
...
- Discover design docs: `ls -t ~/.hermes/projects/$SLUG/*-design-*.md 2>/dev/null | head -1`
...
- Test plan: generate artifact at `~/.hermes/projects/$SLUG/{user}-{branch}-test-plan-{datetime}.md`
...
- [ ] Test plan artifact written to disk at ~/.hermes/projects/$SLUG/
- [ ] "NOT in scope" section written
- [ ] "What already exists" section written
