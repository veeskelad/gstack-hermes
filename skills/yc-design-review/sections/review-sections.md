...
|----------------|-------------|-----------|-------|
| [screen name]  | ~/.hermes/projects/$SLUG/designs/[folder]/[filename].png | [brief description] | [constraints from review] |
```
...
- **B)** Run /yc-ceo-review (only if fundamental product gaps found)
