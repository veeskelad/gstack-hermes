...
# /yc-design-review: Designer's Eye Plan Review
...
MUST be saved to `~/.hermes/projects/$SLUG/designs/`, NEVER to `.context/`,
...
|------|-------------------|
| running the 7 design passes, required outputs, and review report (only after Step 0 scope is agreed) | `sections/requesting-code-review-sections.md` |
---
...
`~/.hermes/projects/$SLUG/designs/` (user config directory, not project files).
...
- `mkdir -p ~/.hermes/projects/$SLUG/designs/...`
...
Re-run loop: invoke /yc-design-review again → re-rate → sections at 8+ get a quick pass, sections below 8 get full treatment.
...
> **STOP.** Before running the 7 design passes, required outputs, and review report (only after Step 0 scope is agreed), Read `~/.claude/skills/gstack/yc-design-review/sections/requesting-code-review-sections.md` and execute it
> in full. Do not work from memory — that section is the source of truth for this step.

## Section self-check (before you finish)

Confirm you Read the review section the Section index named, and executed all 7 design passes, the required outputs, and the review report in full. If you produced findings or the review report from memory without Reading `sections/requesting-code-review-sections.md`, stop and Read it now.
