...
Use before /yc-ceo-review or /yc-eng-review.
...
4. **List existing design docs for this project:**
   ...
   ls -t ~/.hermes/projects/$SLUG/*-design-*.md 2>/dev/null
   ```
...
```bash
setopt +o nomatch 2>/dev/null || true  # zsh compat
grep -li "<keyword1>\|<keyword2>\|<keyword3>" ~/.hermes/projects/$SLUG/*-design-*.md 2>/dev/null
```
...
This enables cross-team discovery — multiple users exploring the same project will see each other's design docs in `~/.hermes/projects/`.
...
(`/yc-design-review`, `/design-review`) to see what was originally envisioned.
...
> **STOP.** Before writing the design doc and running the tiered relationship handoff (Phases 5-6, after the conversation and alternatives are done), Read `~/.claude/skills/gstack/yc-office-hours/sections/design-and-handoff.md` and execute it
